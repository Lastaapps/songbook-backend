package cz.lastaapps.base.data.brnkni
...
import cz.lastaapps.base.domain.sources.BrnkniDataSource
...
internal class BrnkniDataSourceImpl(
        ...
        return commonRequest(query, true)
            ...
            .map { html ->
                ...
                songItemMatcher.findAll(main).map { match ->
                    ...
                    SearchedSong(songLink, songName, authorName, songType)
                }.toPersistentList()
    ...
    override suspend fun loadSongsForAuthor(author: Author): Result<ImmutableList<SearchedSong>> {
        ...
        return authorSongItemMatcher.findAll(main).map { match ->
            ...
            SearchedSong(link, name, author.name, songType)
